...
// Define a function, iterate, that accepts a callback. Within the iterate() function, you should initialize array.
...
function iterate(stupidCallback) {
  let myArray = [1, 2, 3, 4];
  myArray.forEach(stupidCallback)
  return myArray
};

function stupidCallback(shit) {
  return shit
}
